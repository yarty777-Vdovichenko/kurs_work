...
export default function Home()
{
    ...
    <div className="backgroud">
        <div className="hero">
            ...
            <svg className="svg--left" width="200" height="672" viewBox="0 0 719 872" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className="svg--right" width="285" height="274" viewBox="0 0 685 374" fill="none" xmlns="http://www.w3.org/2000/svg">
